      ...
      function submit(){
        ...
        for(i=0; i<points.length; i++){
          if(points[i].deleted != true){
            ...
            var description = points[i].description_field.value;
            var name = points[i].name_field.value;

            xmlhttp.open("POST","points/",true);
            xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            xmlhttp.send("name="+name+"&description="+description+"&latitude="+lat+"&longitude="+lng);
          }
        }
      }
    </script>
